        ...
        <div className="ms-base-page pb-5">
            ...
            <section>
                ...
                <p>
                    ...
                    Your information when You use any of our mobile apps, visit our website at letstag.app or engage with us in other related ways - including sales, marketing or
                    events.
                </p>
                <p>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to LetsTag LLC, Austin, TX 78749.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to LetsTag, accessible from <a href="https://letstag.app/" rel="external nofollow noopener" target="_blank">https://letstag.app/</a></p>
                    </li>
                    <li>
            ...
            <section>
                ...
                <h5>Information Collected on Device with our App</h5>
                <p>
                    We may request access or permission to certain features from your device, including your mobile device's and other features. If you wish to change our access or permissions, you may do so in your device's settings. This information is primarily needed to maintain the security and operation of our App, for troubleshooting and for our internal analytics and reporting purposes.
                    <ul>
                        <li>
                            <strong>Mobile Device Access. </strong> We may request access or permission to certain features from your mobile device, including your mobile device's apple health, and other features. If you wish to change our access or permissions, you may do so in your device's settings.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Push Notifications.</strong> We may request to send you push notifications regarding your account or certain features of the App. If you wish to opt-out from receiving these types of communications, you may turn them off in your device's settings.
                        </li>
                    </ul>
                </p>
                ...
                <p>We use Cookies or similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies might include
                    ...
                    Learn more about cookies: <a href="https://termsfeed.com/blog/cookies/" target="_blank">All About Cookies</a>
                </p>
                <p>We use "Persistent" (remain on your personal computer or mobile device when You go offline) and "Session" (deleted as soon as You close your web browser)
                ...
                <ul>
                    <li>
                        ...
                        <p>Purpose: To provide You with services available through the Website and to enable You to use some of its features. It helps to authenticate users
                            and prevent fraudulent use of user accounts. Without it the services that You have asked for cannot be provided, and We only use these to provide You with those services.</p>
                    </li>
                    <li>
                        <p><strong>Functionality</strong></p>
                        <p>Type: Persistent</p>
                        <p>Administered by: Us</p>
                        <p>Purpose: Allows us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
                    </li>
                </ul>
                <h5>Control for DO-NOT-TRACK features</h5>
                <p>
                ...
                <ul>
                    ...
                    <li><strong>Other legal requirements:</strong> The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:
                        <ul>
                ...
                <h5>Use of your Personal Data might be for the following purposes:</h5>
                <ul>
                    <li><strong>To provide and maintain our Service</strong>, including to monitor the usage of our Service.</li>
                    <li><strong>To manage Your Account:</strong> to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</li>
                    <li><strong>For the performance of a contract:</strong> Where we have entered into a contract with you, we may process your personal information to fulfill the terms of our contract.</li>
                    ...
                    <li><strong>For Legitimate Interests:</strong> We may process your data when it is reasonably necessary to achieve our legitimate business interests.</li>
                ...
                <h5>Sharing of your personal information might be in the following situations:</h5>
                <ul>
                ...
                <p>By using our Service you consent to this Privacy Policy and Your agreement to that transfer.</p>
            ...
            <section>
                ...
                <p>
                    ...
                    to complain to your local data protection supervisory authority. You can find their contact details here: <a data-custom-class="link" href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm" rel="noopener noreferrer" target="_blank">https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</a>.
                </p>
                <p>
            ...
            <section>
                ...
                <p>In order to exercise any of Your rights under the CCPA, and if you are a California resident. The California Code of Regulations defines a "resident" as:
                    <ul>
                ...
                <p>LetsTag LLC has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding 12 months. LetsTag LLC will not sell personal information in the future belonging to website visitors, users and other consumers.</p>
                ...
                <p>To exercise these rights, you can contact us by by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.  </p>
            </section>
